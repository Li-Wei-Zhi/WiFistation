...
Page({
  ...
  send: function () {
    ...
    const requestTask = wx.request({
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=%E5%8C%97%E4%BA%AC&output=json&ak=Gx8G22TvLYja0GxGSaNIfmNjQDcrqOzQ', //百度天气API
      header: {
  ...
  getDataFromOneNet: function () {
    ...
    const requestTask = wx.request({
      url: 'https://api.heclouds.com/devices/503232079/datapoints?datastream_id=Light,Temperature,Humidity&limit=15',
      header: {
        'content-type': 'application/json',
        'api-key': 'pJPQTqgDK58dXk7a=69TVyH8MtI='
      },
      success: function (res) {
